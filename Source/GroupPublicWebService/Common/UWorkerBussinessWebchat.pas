...
begin
  ...
  begin
    ...
    FErrCode := 'S.00';
    FErrDesc := '业务执行成功.';
    WriteLog('TBusWorkerBusinessWebchat.DoWork(FIn.FCommand='+inttostr(FIn.FCommand)+')-耗时：'+InttoStr(MilliSecondsBetween(Now, nBegin))+'ms');
  end;
end;
...
begin
  ...
  WriteLog('TBusWorkerBusinessWebchat.get_shoporderByNO-耗时：'+InttoStr(MilliSecondsBetween(Now, nBegin))+'ms');  
end;
