...
begin
  ...
  try
    ...
    begin
      ...
      FCanCreateSaleCard := ReadBool(FProgID,'CanCreateSaleCard',False);
      FCanCreatePurchaseCard := ReadBool(FProgID,'CanCreatePurchaseCard',False);
      FAutoClose_Mintue := ReadInteger(FProgID, 'AutoCloseMintue', 1);
      FQueuePromt := ReadString(FProgID,'QueuePromt','请进厂');
